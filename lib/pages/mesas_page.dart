...
class _MesasViewState extends State<_MesasView> {
  ...
  void _abrirModalAgregarEditar(MesasProvider provider, {Mesa? mesa, int? index}) {
    if (mesa != null) {
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  if (mesa != null && index != null) {
                    provider.updateMesa(index, Mesa(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 20),
                _buildKpiCard('Por cobrar', provider.porCobrar, const Color(0xFFFFB347)),
              ],
            ),
            const SizedBox(height: 32),
            ...
            Expanded(
              child: ListView(
                children: provider.areas.where((area) => provider.filtroSeleccionado == 'Todas' || provider.filtroSeleccionado == area).map((area) {
                  final mesasEnArea = provider.mesas.where((m) => m.area == area).toList();
                                  ...
                                  child: Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () => _abrirModalAgregarEditar(provider, mesa: mesa, index: provider.mesas.indexOf(mesa)),
                                      ),
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () => _solicitarBorrado(provider, mesa),
                                      ),
                                    ],
                                  ),
                                ),
