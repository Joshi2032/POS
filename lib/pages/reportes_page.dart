...
class _ReportesView extends StatelessWidget {
  ...
  Widget _buildPaymentTypeIndicator(String l, String v, double p, Color c) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text(l), Text(v, style: const TextStyle(fontWeight: FontWeight.bold))]), const SizedBox(height: 6), LinearProgressIndicator(value: p.isNaN ? 0.0 : p, color: c)]);
}