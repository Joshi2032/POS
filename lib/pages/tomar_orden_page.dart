...
class TomarOrdenPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              // breakpoint de 1200px igual al CSS (@media (max-width: 1200px))
        ...
        // FAB flotante únicamente activo en vistas móviles o tablets
  ...
  // Abre el carrito en la parte inferior como un Drawer en móviles (Media queries adaptados)
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ChangeNotifierProvider.value(
          value: provider,
          child: SizedBox(
            height: MediaQuery.of(context).size.height * 0.76, // max-height: 76vh;
        ...
        children: [
          ...
          TextField(
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor: Colors.grey[100], // var(--bg-tertiary)
          ...
          // Chips horizontales de Categoría (*ngFor="let category of categories")
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Lista de Productos en el carrito (cart-items)
        Expanded(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: provider.cart.isEmpty
                      ...
                      : () {
                          provider.sendOrder();
                          if (isMobile) Navigator.pop(context); // Cierra bottom sheet si aplica
