...
class _CajaPageState extends State<CajaPage> {
  ...
  void initState() {
    ...
    pendingOrders = [
      ...
      CashOrder(
          ...
          time: '06:50 p.m.',
          total: 320.0,
          items: [OrderItem(name: 'Costillas BBQ', qty: 1, price: 320.0)])
    ];
  ...
  CashOrder? get selectedOrder {
    ...
    return pendingOrders.firstWhere((order) => order.id == selectedOrderId,
        orElse: () => pendingOrders.last);
  }

  int get paidTodayCount => paidToday.length;

  double get totalInCash =>
      paidToday.fold(0.0, (sum, order) => sum + order.total);
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Órdenes por cobrar (${pendingOrders.length})',
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(_formatMoney(pOrder.total),
                                                  style: const TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 16)),
                            ...
                            // BLOQUE: Cobradas hoy
                            Text('Cobradas hoy ($paidTodayCount)',
                                style: const TextStyle(
                                    fontSize: 16, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 10),
                            ListView.builder(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(_formatMoney(pToday.total),
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                color: Colors.grey)),
                                      ],
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                      ...
                      onPressed: closeSelectedOrderPanel,
                      iconSize: 20,
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text('${item.qty} x ${_formatMoney(item.price)}',
                              style: const TextStyle(
                                  color: Colors.grey, fontSize: 12)),
                        ],
                      ),
                      Text(_formatMoney(item.qty * item.price),
