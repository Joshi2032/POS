...
class CustomSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inactiveColor =
        isDark ? const Color(0xFF9F9F9F) : const Color(0xFF6B6B6B);
                ...
                Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    leading: Icon(Icons.settings_input_component_outlined,
                        color:
                            isControlPanelActive ? activeColor : inactiveColor,
                        size: 20),
                    title: Text('Panel de Control',
                        style: TextStyle(
                            fontSize: 13,
                            fontWeight: FontWeight.w600,
                            color: isControlPanelActive
                                ? activeColor
                                : textColor)),
  ...
  Widget _buildMenuItem(BuildContext context,
      {required String title, required String path, required IconData icon}) {
    ...
    return Padding(
      ...
      child: ListTile(
        ...
        leading: Icon(icon,
            color: isSelected ? activeColor : inactiveColor, size: 20),
        title: Text(title,
            style: TextStyle(
                fontSize: 13,
