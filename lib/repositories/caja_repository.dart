...
class CajaRepository {
  ...
  Future<double> obtenerTotalEnCaja() async {
    try {
      ...
      print('Error al obtener total en caja de Supabase: $e');
      return 0.0;
    }
  }
    ...
    try {
      ...
      await _client
          ...
          .update({
            ...
            'paid_at': DateTime.now().toIso8601String() // Fecha y hora exacta del cobro
          })
          .eq('id', orderId); // Apuntamos a la orden específica

    } catch (e) {
      print('Error al registrar el cobro en Supabase: $e');
